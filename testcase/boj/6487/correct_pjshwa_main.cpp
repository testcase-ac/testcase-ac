...
void solve() {
  ...
  if (isEqual(x1, x2)) {
    if (isEqual(x3, x4)) {
      ...
      cout << fixed << setprecision(2) << "POINT " << x1 << ' ' << yp;
    ...
    if (isEqual(x3, x4)) {
      ...
      cout << fixed << setprecision(2) << "POINT " << x3 << ' ' << yp;
      ...
      if (isEqual(a1, a2)) {
        ...
        if (isEqual(y1, a2 * (x1 - x3) + y3)) cout << "LINE";
        else cout << "NONE";
      }
      else {
        ...
        cout << fixed << setprecision(2) << "POINT " << xp << ' ' << yp;
        // cout << (
