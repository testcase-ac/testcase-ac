...
int main() {
	random_device rd;
	mt19937_64 g(rd());
    uniform_int_distribution<int> T(1,50);
	uniform_int_distribution<int> n(1,35);
    uniform_int_distribution<long long> m(1,1000000000000000000LL);
    uniform_int_distribution<long long> p(2,1073741824);
    int t=T(g);
    cout<<t<<'\n';
    while(t--) {
        long long P;
