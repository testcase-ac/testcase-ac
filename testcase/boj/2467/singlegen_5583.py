...
print(N)
values = []
# Add negatives: -1000000000, -999999999, ..., -1000000000+49999
for i in range(50000):
    values.append(-1000000000 + i)
# Add positives: 999950001, 999950002, ..., 1000000000
for i in range(50000):
    values.append(1000000000 - 49999 + i)
print(*values)
