...
const translations = {
  en: {
    ...
    "home.generator.none": "No Generator",
    ...
    "problem.totalExecutionCount": "Total execution count",
    "stats.title": "Statistics",
    "stats.lastSevenDays": "Executions in the last 7 days",
    "stats.loading": "Loading statistics...",
    "stats.unavailable": "Statistics are temporarily unavailable.",
    "stats.chartLabel": "Hourly executions for the last 7 days",
    "stats.topProblems": "Top problems in the last 7 days",
    "stats.rank": "Rank",
    "stats.problem": "Problem",
    "stats.executions": "Executions",
    "stats.noExecutions": "No executions in this window.",
    ...
    "problem.progress.preparing": "Preparing...",
    "problem.progress.compilingTitle": "Compiling...",
    "problem.progress.compileComplete": "Compile complete",
    "problem.progress.compiling": "Compiling {source}",
    "problem.progress.running": "Stressing... ({completed} iterations done)",
    "problem.progress.stressDone": "Stress run complete",
    "problem.progress.finalizing": "Finalizing...",
    "problem.progress.source.target": "Your submission",
    "problem.progress.source.unknown": "Source code",
    ...
    "stress.label.checkerOutput": "Checker output",
  ...
  ko: {
    ...
    "problem.timeLimit": "시간 제한",
    "problem.memoryLimit": "메모리 제한",
    "problem.totalExecutionCount": "총 실행 횟수",
    "stats.title": "통계",
    "stats.lastSevenDays": "최근 7일 실행 횟수",
    "stats.loading": "통계를 불러오는 중...",
    "stats.unavailable": "통계를 일시적으로 사용할 수 없습니다.",
    "stats.chartLabel": "최근 7일 시간별 실행 횟수",
    "stats.topProblems": "최근 7일 실행 횟수 상위 문제",
    "stats.rank": "순위",
    "stats.problem": "문제",
    "stats.executions": "실행 횟수",
    "stats.noExecutions": "이 기간에 실행 기록이 없습니다.",
    ...
    "problem.progress.preparing": "준비 중...",
    "problem.progress.compilingTitle": "컴파일 중...",
    "problem.progress.compileComplete": "컴파일 완료",
    "problem.progress.compiling": "{source} 컴파일 중",
    "problem.progress.running": "스트레스 테스트 중... ({completed}회 완료)",
    "problem.progress.stressDone": "스트레스 테스트 완료",
    "problem.progress.finalizing": "마무리 중...",
    "problem.progress.source.target": "제출 코드",
    "problem.progress.source.unknown": "소스 코드",
    ...
    "stress.label.checkerOutput": "체커 출력",
    "stress.label.stderr": "stderr",
